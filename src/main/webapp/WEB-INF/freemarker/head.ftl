...
<#--<#else >-->
    <div style="height: 50px;background-color: red" >
        <div  style="height: 50px;width: 50%;float: left" id="login">请<a href="/spring-web/login.html">[登陆]</a></div>
        <div  style="height: 50px;width: 50%;float:right" id="begin"><a href="/spring-web/api/content/list">首页</a></div>
    </div>
